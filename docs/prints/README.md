# Prints versionadas (entrega)

Imagens referenciadas em [`parte-teorica.md`](../parte-teorica.md):

| Arquivo | Conteúdo | Seção |
|---------|----------|-------|
| `04-uml-casos-de-uso.png` | Diagrama de casos de uso | 4 |
| `05-uml-classes.png` | Diagrama de classes | 5 |
